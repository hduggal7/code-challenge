...
using challenge.Controllers.Comp;
...
namespace code_challenge.Tests.Integration
{
    ...
    public class EmployeeControllerTests
    {
        ...
        [TestMethod]
        public void GetDirectReortsByEmployeeById_Returns_Ok()
        {
            // Arrange
            var employeeId = "16a596ae-edd3-4847-99fe-c4518e82c86f";
            ...
            // Assert
            Assert.AreEqual(HttpStatusCode.OK, response.StatusCode);
            var employeeStructure = response.DeserializeContent<TotalReports>();
            Assert.AreEqual(employeeId, employeeStructure.Employee.EmployeeId);
            Assert.AreEqual(numberOfReports, employeeStructure.NumberOfReports);
        }
        ...
        public void CreateCompensation_Returns_Created()
        {
            ...
            var compensation = new Compensation()
            {
                ...
                salary = 10000,
                effectiveDate = new DateTime(2019, 05, 09, 9, 15, 0),
        ...
        public void GetCompensationByEmployeeId_Returns_Ok()
        {
            ...
            var employeeId = "16a596ae-edd3-4847-99fe-c4518e82c86f";
            var salary = 10000;
            var effectiveDate = new DateTime(2019, 05, 09, 9, 15, 0);
